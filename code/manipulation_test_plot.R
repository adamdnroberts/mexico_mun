...
plotPAN <- rdplotdensity(mtPAN, df$PAN_pct, xlabel = "PAN vote share") #, plotRange = c(-0.3,0.3))
plotPRD <- rdplotdensity(mtPRD, df$PRD_pct, xlabel = "PRD vote share") #, plotRange = c(-0.3,0.3))
