...
for (n in n_values) {
  ...
  p1_90 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 90)
  p2_90 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 2,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 90)
  p3_90 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 3,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 90)
  
  p1_95 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 95)
  p2_95 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 2,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 95)
  p3_95 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 3,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 95)
...
ggsave(filename = "C:/Users/adamd/Dropbox/Apps/Overleaf/TYP Final Tables and Figures Appendix/images/PRD_5_poly.png", plot = p, width = 6, height = 4)
...
for (n in n_values) {
  ...
  mse_90 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "mserd", level= 90)
  cer_90 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 90)
  
  mse_95 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "mserd", level= 95)
  cer_95 <- rdrobust(y = df_n$change_pp_wt, x = df_n$PRD_margin, p = 1,  covs = cbind(df_n$main_year, df_n$main_estado,df_n$weighted_avg_dH), bwselect = "cerrd", level= 95)
...
ggsave(filename = "C:/Users/adamd/Dropbox/Apps/Overleaf/TYP Final Tables and Figures Appendix/images/PRD_5_bw.png", plot = p, width = 6, height = 4)
