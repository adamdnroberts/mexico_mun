...
df_rdd_PRD <- subset(
  rdd_PRD_subset,
  ref_PRD_wins == 0 & main_estado == ref_estado
)
...
p <- ggplot(plot_data, aes(x = n, y = est)) +
  ...
  geom_point(size = 2.5) +
  labs(
    x = "Number of Neighbors in Weighted Average",
    y = "RD Estimate",
    title = "",
    subtitle = "",
...
ggsave(
  filename = "C:/Users/adamd/Dropbox/Apps/Overleaf/TYP/images/PRD_5_nearest_w_controls.pdf",
  plot = p,
  width = 6,
  height = 4
)
...
ggsave(
  filename = "C:/Users/adamd/Dropbox/Apps/Overleaf/TYP Final Tables and Figures Appendix/images/PRD_5_poly.png",
  plot = p,
  width = 6,
  height = 4
)
...
ggsave(
  filename = "C:/Users/adamd/Dropbox/Apps/Overleaf/TYP Final Tables and Figures Appendix/images/PRD_5_bw.png",
  plot = p,
  width = 6,
  height = 4
)
